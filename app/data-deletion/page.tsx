  ...
  return (
    ...
    >
      ...
      <LegalSection title="المدة والاستثناءات">
        ...
        <p>
          لمنع إساءة استخدام التجربة المجانية، نحتفظ بعد الحذف بقيمة مجزّأة (hash) غير قابلة للعكس مشتقّة من بريدك
          الإلكتروني فقط — لا نحتفظ بالبريد نفسه ولا بأي بيانات أخرى — للتأكد أن كل مستخدم يحصل على تجربة واحدة.
        </p>
      </LegalSection>
    </LegalPage>
  );
