  ...
  return (
    ...
    >
      ...
      <LegalSection title="الحفظ والأمان">
        ...
        <p>
          استثناءً من الحذف الكامل: نحتفظ بقيمة مجزّأة (hash) غير قابلة للعكس مشتقّة من بريدك الإلكتروني حتى بعد حذف
          الحساب، لغرض واحد فقط هو منع تكرار التجربة المجانية. لا يحتوي هذا السجل على بريدك الصريح أو أي بيانات أخرى.
        </p>
      </LegalSection>
